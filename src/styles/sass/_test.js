const styles = {
	...
	'.header .header-container .brand': { display: 'flex', alignItems: 'center' },
	...
	'@media only screen and (max-width: 767px)': {
		'.header': {
			width: 'var(--topbar-mobile-width) px',
			height: '100vh',
			left: 'auto',
			right: '0',
		...
		'.header.closed': { right: 'calc(-var(--topbar-mobile-width) px - 5px)' },
